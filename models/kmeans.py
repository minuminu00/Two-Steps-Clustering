...
def kmeans(args, x_train, label_train) -> list:
    """
    CAE+kmeans
    """
    ...
    args.maxiter          = 0          # type=int **
    args.gamma            = 0.04       # type=float, help='coefficient of clustering loss'
    args.update_interval  = 150        # type=int, help='This argument must be given'
    args.tol              = 1e-5       # type=float
    args.n_init           = 1          # type=int, help='클러스터링 초기값 정할때 몇번 돌릴지 결정'
